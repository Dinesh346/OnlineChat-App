...
useEffect(()=>{
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
        ...
        {onlineUsers.includes(selectedUser._id) && <span className='w-2 h-2 rounded-full bg-green-500'></span>}
            ...
            <img onClick={()=>setSelectedUser(null)} src={assets.arrow_icon} alt='call' className='md:hidden max-w-7'/>
  ...
  <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
             ...
             {/* -----------Input Box------------ */}
  <div className="flex items-center flex-1 bg-gray-700 px-3 rounded-full">
    ...
    <label htmlFor="image" className="cursor-pointer">
      <img src={assets.gallery_icon} alt="upload" className="w-6 h-6 mr-2" />
    </label>
  </div>
